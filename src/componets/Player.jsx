...
const Player = ({
  ...
  return (
    ...
    >
      <Image src={track.img} w={{base:"65vw", sm:'40vh'}} borderRadius={10} />
      <Flex flexDirection={"column"} alignItems={'center'}
      justifyContent={'space-between'} h={"40%"} w={"100%"} mb={12}>
      ...
      <Flex alignItems={'center'}>
        <IconButton
          colorScheme={'none'}
          icon={volume ? <SoundOnIcon boxSize={6}/> : <SoundOffIcon boxSize={6}/>}
